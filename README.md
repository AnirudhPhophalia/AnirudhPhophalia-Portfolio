...
src/projects.js       data/skills.json       ./Anirudh_Phophalia_Resume.pdf
```
...
|---|---|
| **Explorer** | The résumé as a file tree, with hand-drawn language glyphs per extension (React atom, HTML5 shield, JS/TS badges, `{}`, CSS, Markdown, PDF). |
| **Tabs** | Multiple files open at once, closable, order preserved across reloads. Double-click or right-click an open tab for a VS Code-style menu with close, close others, close to the right, close all, path-copy, and new-window actions. |
...
|:--|:--|:--|:--|:--|:--|
| 💙 **Anirudh Dark** | `#1e1e1e` | `#252526` | ![](https://img.shields.io/badge/-007acc-007acc?style=flat-square) `#007acc` | `#4fc1ff` | `#007acc` |
...
```bash
git clone https://github.com/AnirudhPhophalia/Portfolio-AnirudhPhophalia.git
cd Portfolio-AnirudhPhophalia
npm install
npm run dev
```
...
- **Tab actions** — double-clicking or right-clicking an open tab opens a menu for closing tab groups, copying file paths, and opening the portfolio in a new window.
...
Designed and built by **Anirudh Phophalia**
<br />
[GitHub](https://github.com/AnirudhPhophalia) · [LinkedIn](https://www.linkedin.com/in/anirudh-phophalia) 
